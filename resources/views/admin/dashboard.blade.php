                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-blue-50 p-6 rounded-lg shadow">
                            ...
                            <p class="text-gray-600 mb-4">Manage all companies in the system. Add new companies, edit existing ones, or remove companies that are no longer needed.</p>
                        ...
                        <div class="bg-green-50 p-6 rounded-lg shadow">
                            ...
                            <p class="text-gray-600 mb-4">Manage all employees in the system. Add new employees, edit their information, or remove employees as needed.</p>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg shadow">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div class="bg-white p-4 rounded shadow">
                                    <h5 class="text-sm font-medium text-gray-500 mb-1">Companies with Logo</h5>
                                    <p class="text-2xl font-bold">{{ \App\Models\Company::whereNotNull('logo')->count() }}</p>
                                </div>
                                <div class="bg-white p-4 rounded shadow">
                                    <h5 class="text-sm font-medium text-gray-500 mb-1">Employees with Email</h5>
