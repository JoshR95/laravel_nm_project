    ...
    <div class="py-12">
        <div class="flex flex-col justify-center min-h-[70vh]">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-[#124d51] border overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <div class="mt-6 ">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="bg-white p-6 rounded-lg shadow">
                                        <h4 class="text-md font-medium mb-4 flex items-center text-blue-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-500" viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                                            </svg>
                                            Companies  Management
                                        </h4>
                                        <p class="text-blue-500 mb-4">Manage all companies in the system. Add new companies, edit existing ones, or remove companies that are no longer needed.</p>
                                    ...
                                    <div class="bg-white p-6 rounded-lg shadow">
                                        <h4 class="text-md font-medium mb-4 flex items-center text-green-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-green-500" viewBox="0 0 20 20" fill="currentColor">
                                                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                                            </svg>
                                            Employees Management
                                        </h4>
                                        <p class="text-green-500 mb-4">Manage all employees in the system. Add new employees, edit their information, or remove employees as needed.</p>
